...
// echo $email;
$findresult = mysqli_query($conn, "select * from alumnisignup where email='$email'");
...
<div class="row heading"  style="background-color:#37517e;">
          <div class="col-sm-3 col-xs-3 heading-avatar">
            <div class="heading-avatar-icon">
              <img src="./images/155.jpg"  alt="user-profile">
            </div>      
          </div>
     <div  style='width:100px'class="col-sm-1 col-xs-1  heading-dot  pull-left" >
         <a class="heading-name-meta" style="color:white" ><?php echo $name ?></a>
...
<!--          search-->
        ...
        <!-- <div class="row searchBox">
          <div class="col-sm-12 searchBox-inner">
            <div class="form-group has-feedback">
              ...
              <input id="searchText" type="search" class="form-control" name="searchText" placeholder="Search on the basis of company">
		...
		<div class="row searchBox">
          <div class="col-sm-12 searchBox-inner">
            <div class="form-group has-feedback">
                <form class="search_user" action="" method="post">
              <input id="searchText" type="search" class="form-control" name="searchText1" placeholder="Search on the basis of technology">
             <button class="search_btn" type="submit" name='search1'><i class="fa fa-search"></i></button></form>
            </div>
          </div>
        </div>
		...
		<div class="row searchBox">
          <div class="col-sm-12 searchBox-inner">
            <div class="form-group has-feedback">
                <form class="search_user" action="" method="post">
              <input id="searchText" type="search" class="form-control" name="searchText2" placeholder="Search on the basis of domain">
             <button class="search_btn" type="submit" name='search2'><i class="fa fa-search"></i></button></form>
            </div>
          </div>
        </div> -->
...
<!--     left side bar - frequent chat -->
    ...
    <?php include('include/get_frequent_user_new.php'); ?>
            </div>
          </div>
...
<!--left side bar two (settings)-->
		  <div class="side-two">
			    <div style="background-color:#37517e;" class="row newMessage-heading">
        ...
        <div class="row compose-sideBar">
            ...
            <div class="row sideBar-body " onclick="profiletogglebar()" style="height:90px;">
				...
				<div class="col-sm-9 col-xs-9 sideBar-main">
					<div  style='width:100px'class="col-sm-1 col-xs-1  heading-dot  pull-left">
					    <a style="text-decoration:none;font-size:15px;color:black;" ><?php echo $name ?></a><br>
		...
		<br><br>
			<form action="" method="POST" enctype="multipart/form-data" >
                <div class="profileimage">			
					<img style="left:100px;"src="./images/155.jpg" width="150px" height="150px" ><br><br>
				...
				<div class="box">
					<div class="profiletext">
						<input style="margin-left:130px;" type="text" name="username" value="<?php echo $name?>" required>
	...
	<div class='side-three' id="conus">	
         <div style="background-color:#37517e;" class="row newMessage-heading">
            ...
            <br><br>
                ...
                <br><br>        
                 <input type="hidden" name="from" value="<?php echo $name ?>" >
...
<!--        heading-->
        ...
        <?php include('include/get_clicked_user copy.php') ?>
...
if (isset ($_GET['user_name'])) { ?>
      ...
      <div class="row message" id="conversation" >
        <div class="row message-previous">
         ...
         <?php 
    $read_up=mysqli_query($con,"UPDATE users_chat SET Msg_status='read' WHERE Sender_email='$clicked_email'
    AND Receiver_email='$email'");
 $all_mes="SELECT * FROM users_chat WHERE (Sender_email='$clicked_email' AND Receiver_email='$email') OR 
 (Sender_email ='$email' AND Receiver_email ='$clicked_email') ORDER BY 1 ASC";
//        $all_mes='select * from users_chat ';
    $all_result=mysqli_query($con,$all_mes);
    while($rows=mysqli_fetch_assoc($all_result))
    {
        
    $sender_name=$rows['Sender_email'];
    $receiver_name=$rows['Receiver_email'];
    $msg_content=$rows['Msg_content'];
    $msg_date=$rows['Msg_date'];
              
        
        if($email == $sender_name && $clicked_email== $receiver_name)
        {
...
<?php } 
             if($email == $receiver_name && $clicked_email== $sender_name )
        {
          ?>
        <div class="row message-body">
...
<!--        right-side emoji panel-->
        ...
        <!--        keyboard - message-->
      <div style='background-color:#37517e'class="row reply">
        <form action="" method="POST" >
            ...
            <div class="col-sm-1 col-xs-1 reply-send">
                <button style='background-color:#37517e;border:none;outline:none;'  name="send" > <i style="color:white" class="fa fa-send fa-2x" aria-hidden="true"></i></button>
            </div>
        </form>
      </div>
        <?php include('include/send copy.php') ?>
...
<!--        right info-->
        ...
        <div class='right-side-one 'id="clickedprofile">
			...
			<form>
                <div class="profileimage">			
					<img src="./images/155.jpg" align="center"width="150px" height="150px" ><br><br>
    			</div>
				<div class="box">
					<div class="profiletext">
					...
					<div class="profiletext">
						<input type="text"style="margin-left:50px;" name="country"  value="<?php echo $clicked_tech?>" readonly>
					</div>
					<div class="profiletext">
						<input type="text"style="margin-left:50px;" name="company" value="<?php echo $clicked_company?>" readonly>
					</div>
					<div class="profiletext">
						<input type="text"style="margin-left:50px;" name="company" value="<?php echo $clicked_role?>" readonly>
					</div><br>
                </div>
			</form>
     </div>
