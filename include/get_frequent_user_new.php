 <?php 
          include('db_connect.php');
           $except =$email;
          $query="SELECT * FROM Signup WHERE pos='Student'";    
         ...
         while($row=mysqli_fetch_assoc($result)){   
            ...
            //  $Profile=$row['Profile'];
             ...
             $a_name=$row['Username'];
              ...
              $query2="SELECT * FROM users_chat WHERE (Sender_email='$e_mail' AND  Receiver_email='$except') OR (Sender_email='$except' AND  Receiver_email='$email')ORDER BY Msg_id DESC LIMIT 1 ";
...
//             number of unread message -Notification
             $total_mes="SELECT * FROM users_chat WHERE (Sender_email ='$e_mail' AND Receiver_email ='$except') AND (Msg_status='unread')";
             $total_result=mysqli_query($con,$total_mes);
             $total_rows=mysqli_num_rows($total_result);
 
                
?>
          <a href='chatwithstu.php?user_name=<?php echo $e_mail?>' ><div class="row sideBar-body">
