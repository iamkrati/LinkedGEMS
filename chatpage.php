...
if (isset ($_GET['user_name'])) { ?>
    ...
    AND Receiver_email='$eid'");
 $all_mes="SELECT * FROM users_chat WHERE (Sender_email='$clicked_email' AND Receiver_email='$eid') OR 
 (Sender_email ='$eid' AND Receiver_email ='$clicked_email') ORDER BY 1 ASC";
//        $all_mes='select * from users_chat ';
    ...
    $msg_date=$rows['Msg_date'];
        ...
        if($eid == $sender_name && $clicked_email== $receiver_name)
        {
...
<?php } 
             if($eid == $receiver_name && $clicked_email== $sender_name )
        {
          ?>
        <div class="row message-body">
...
alert("Welcome to our chat application");
}  
